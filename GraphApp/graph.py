...
class Graph:
    ...
    def floyd_warshall(self):
        ...
        For each vertex, consider it as a possible intermediate vertex in the shortest path
        between every pair of vertices (i, j).
        Update dist[i][j] if there exists a path from i to j
        through vertex k that has a shorter distance
        than the current value of dist[i][j].
